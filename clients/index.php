...
class Example1 extends Common
{
	...
	function initiateEditor()
	{
		...
		$tableColumns['Display Name'] = array('display_text' => 'Display Name', 'perms' => 'EVCTAXQSHO');
		$tableColumns['Short Code'] = array('display_text' => 'Short Code', 'perms' => 'EVCTAXQSHO');
		$tableColumns['Google Analytics ID'] = array('display_text' => 'Google Analytics ID', 'perms' => 'EVCTAXQSHO');
		$tableColumns['Twitter Handle'] = array('display_text' => 'Twitter Handle', 'perms' => 'EVCTAXQSHO'); 
		...
		$this->Editor->setConfig('orderByColumn','Short Code');
		$this->Editor->setConfig('addRowTitle','Add Client');
		$this->Editor->setConfig('editRowTitle','Edit Client');
